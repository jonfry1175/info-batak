      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mb-16">
          <div className="bg-accent/10 border-accent mb-8 rounded-lg border-l-4 p-8">
            <h2 className="text-accent mb-4 text-3xl font-bold">Dalihan Na Tolu</h2>
          ...
          <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="bg-foreground/5 border-foreground/10 rounded-lg border p-6">
              ...
              <h3 className="text-accent mb-3 text-xl font-bold">Hula-hula</h3>
            ...
            <div className="bg-foreground/5 border-foreground/10 rounded-lg border p-6">
              <div className="mb-4 text-4xl">👥</div>
              <h3 className="text-accent mb-3 text-xl font-bold">Dongan Tubu</h3>
              <p className="text-foreground/70 mb-2 text-sm">
                <em>Sesama Marga</em>
              </p>
              <p className="text-foreground/80 text-sm">
            ...
            <div className="bg-foreground/5 border-foreground/10 rounded-lg border p-6">
              <div className="mb-4 text-4xl">👶</div>
              <h3 className="text-accent mb-3 text-xl font-bold">Boru</h3>
              <p className="text-foreground/70 mb-2 text-sm">
        ...
        {/* Upacara Adat */}
        <section className="mb-16">
          <h2 className="mb-6 text-3xl font-bold">Upacara Adat Penting</h2>
          <div className="space-y-6">
            <div className="bg-foreground/5 rounded-lg p-6">
              <h3 className="text-accent mb-2 text-xl font-bold">Mangompoi / Mangulosi</h3>
              <p className="text-foreground/80">
                Upacara pemberian ulos (kain tradisional) yang mengandung makna pemberian
                kehangatan, kasih sayang, dan berkat. Ulos diberikan dalam berbagai momen penting
                seperti pernikahan, kelahiran, atau acara syukuran.
              </p>
            </div>

            <div className="bg-foreground/5 rounded-lg p-6">
              <h3 className="text-accent mb-2 text-xl font-bold">Horja / Pesta Adat</h3>
              <p className="text-foreground/80">
            ...
            <div className="bg-foreground/5 rounded-lg p-6">
              <h3 className="text-accent mb-2 text-xl font-bold">Saur Matua</h3>
              <p className="text-foreground/80">
        ...
        {/* Nilai-nilai Budaya */}
        <section className="mb-16">
          <h2 className="mb-6 text-3xl font-bold">Nilai-nilai Budaya Batak</h2>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="bg-accent/10 border-accent rounded-lg border-l-4 p-6">
              <h3 className="mb-3 text-lg font-bold">Hagabeon, Hamoraon, Hasangapon</h3>
              <p className="text-foreground/80 text-sm">
                Tiga hal yang menjadi tujuan hidup orang Batak: <em>Hagabeon</em> (banyak
                keturunan), <em>Hamoraon</em> (kekayaan), dan <em>Hasangapon</em>{' '}
                (kehormatan/martabat).
              </p>
            </div>

            <div className="bg-accent/10 border-accent rounded-lg border-l-4 p-6">
              <h3 className="mb-3 text-lg font-bold">Marsiajar (Merantau)</h3>
              <p className="text-foreground/80 text-sm">
            ...
            <div className="bg-accent/10 border-accent rounded-lg border-l-4 p-6">
              <h3 className="mb-3 text-lg font-bold">Marsiurupan (Gotong Royong)</h3>
              <p className="text-foreground/80 text-sm">
            ...
            <div className="bg-accent/10 border-accent rounded-lg border-l-4 p-6">
              <h3 className="mb-3 text-lg font-bold">Hormat dan Sopan Santun</h3>
              <p className="text-foreground/80 text-sm">
