      ...
      <div className="w-full px-4 py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="text-foreground/70 mb-12 text-lg leading-relaxed">
            Setiap aspek budaya Batak mencerminkan kebijaksanaan leluhur dan nilai-nilai luhur yang
            diwariskan turun-temurun. Jelajahi berbagai kategori budaya Batak di bawah ini:
          </p>
